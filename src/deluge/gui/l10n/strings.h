...
enum class String : size_t {
	...
	STRING_FOR_COMMUNITY_FEATURE_ACCESSIBILITY_SHORTCUTS,
	...
	// strings for clip output routing (CV audio outputs)
	STRING_FOR_CLIP_OUTPUT,
	STRING_FOR_CLIP_OUTPUT_MAIN,
	STRING_FOR_CLIP_OUTPUT_CV1,
	STRING_FOR_CLIP_OUTPUT_CV2,
	STRING_FOR_CLIP_OUTPUT_STEREO_SPLIT,
	STRING_FOR_OUTPUT_LEVEL,
