...
PLACE_SDRAM_DATA Language seven_segment{
    "Seven Segment",
    {
        ...
        {STRING_FOR_COMMUNITY_FEATURE_AUTOMATION_CLEAR, "CLEA"},
        {STRING_FOR_COMMUNITY_FEATURE_AUTOMATION_NUDGE_NOTE, "NUDG"},
        {STRING_FOR_COMMUNITY_FEATURE_AUTOMATION_SHIFT, "SHIF"},
        ...
        {STRING_FOR_CLIP_OUTPUT, "OUT"},
        {STRING_FOR_CLIP_OUTPUT_MAIN, "MAIN"},
        {STRING_FOR_CLIP_OUTPUT_CV1, "CV1"},
        {STRING_FOR_CLIP_OUTPUT_CV2, "CV2"},
        {STRING_FOR_CLIP_OUTPUT_STEREO_SPLIT, "SPLT"},
        {STRING_FOR_OUTPUT_LEVEL, "OUTL"},
        {STRING_FOR_OUTPUT_LEVEL_CV1, "CV1L"},
        {STRING_FOR_OUTPUT_LEVEL_CV2, "CV2L"},
        {STRING_FOR_AUX, "AUX"},
        {STRING_FOR_CV_SEND, "CV"},
        {STRING_FOR_CV1_SEND, "CV1S"},
        {STRING_FOR_CV2_SEND, "CV2S"},
