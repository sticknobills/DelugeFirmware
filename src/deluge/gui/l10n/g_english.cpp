...
PLACE_SDRAM_DATA Language english{
    "English",
    {
        ...
        {STRING_FOR_SCREENSAVER, "Screensaver"},
        ...
        {STRING_FOR_MIDI_DEVICE_DEFINITION_HIDE, "Hide Unlabeled CC"},
        ...
        {STRING_FOR_RENAME_DRUM, "Rename drum"},
        {STRING_FOR_EDIT_NAME, "Edit name"},
        {STRING_FOR_EDIT_TRACK_NAME, "Edit track name"},
        {STRING_FOR_EDIT_CLIP_NAME, "Edit clip name"},
        ...
        {STRING_FOR_BATTERY_LEVEL_MENU_TITLE, "Battery level"},
        ...
        {STRING_FOR_RESET_MIDI_FOLLOW, "Reset MIDI Follow"},
        {STRING_FOR_RESET_MIDI_DEVICES, "Reset MIDI Devices"},
        ...
        {STRING_FOR_USB_ROUTING, "USB Routing"},
        {STRING_FOR_USB_CHANNEL_1, "USB Channel 1"},
        {STRING_FOR_USB_CHANNEL_2, "USB Channel 2"},
        {STRING_FOR_USB_CHANNEL_3, "USB Channel 3"},
        {STRING_FOR_USB_CHANNEL_4, "USB Channel 4"},
        {STRING_FOR_USB_CHANNEL_5, "USB Channel 5"},
        {STRING_FOR_USB_CHANNEL_6, "USB Channel 6"},
        {STRING_FOR_USB_CHANNEL_7, "USB Channel 7"},
        {STRING_FOR_USB_CHANNEL_8, "USB Channel 8"},
        {STRING_FOR_USB_PAIR_12, "USB Pair 1-2"},
        {STRING_FOR_USB_PAIR_34, "USB Pair 3-4"},
